...
import { QuestionnairesListDataTable } from "../../../utils/data";
...
export default function EnhancedTable() {
	...
	const [orderBy, setOrderBy] = React.useState<any>("questionnairesTitle");
	const [page, setPage] = React.useState(1);
	const [rowsPerPage, setRowsPerPage] = React.useState(5);
	const [rows, setRows] = useState(QuestionnairesListDataTable);
